...
public class SSLManager {
    ...
    public static SSLSocketParams getSslSocketFactory(InputStream[] certificates, InputStream bksFile, String password) {
        ...
        try {
            ...
            if (trustManagers != null) {
                trustManager = new OkHttpTrustManager(chooseTrustManager(trustManagers));
            } else {
                trustManager = new UnSafeTrustManager();
            }
            sslContext.init(keyManagers, new TrustManager[]{trustManager}, new SecureRandom());
            sslSocketParams.sSLSocketFactory = sslContext.getSocketFactory();
            sslSocketParams.sTrustManager = trustManager;
    ...
    private static class OkHttpTrustManager implements X509TrustManager {
